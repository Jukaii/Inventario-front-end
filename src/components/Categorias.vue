<template>
    <div class="registro_categorias">
            <h2>Categorias Lorem Ipsum</h2>
            <form v-on:submit.prevent="processRegCategoria" >
                <div class="user-box">
...
export default {
    ...
    methods: {
        processRegCategoria: function(){
            axios.post(
                "https://sginventario-be.herokuapp.com/categorias/",
                this.user,
                {headers: {}}
            )
                .then((result) => {
                    ...
                    this.$emit('completedRegCategoria', dataSignUp)
                })
                .catch((error) => {
                    console.log(error)
